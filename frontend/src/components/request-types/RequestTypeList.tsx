    ...
    return (
        <section className="space-y-3">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <div className="inline-flex items-center gap-2 rounded-full bg-sky-50 px-2.5 py-1 ring-1 ring-sky-100 mb-1">
                        <span className="text-[11px] text-sky-700 font-medium">Catálogo</span>
                        <span className="h-1 w-1 rounded-full bg-sky-400" />
                        <span className="text-[11px] text-sky-500">
              Tipos de solicitud del flujo
            </span>
                    </div>
                    ...
                    <table className="min-w-full text-sm">
                        ...
                        {!loading && types.length === 0 && (
                            <tr>
                                <td
                                    colSpan={4}
                                    className="px-3 py-6 text-xs text-slate-500 text-center"
                                >
                                    Aún no tienes tipos configurados. Crea el primero desde el panel
                                    de la derecha.
                                </td>
                            </tr>
                        )}
